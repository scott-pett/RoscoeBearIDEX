...
#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_DEFAULT_BRIGHTNESS 3   // Set default power-up brightness (0-255, requires PWM pin)
  ...
  #define CASE_LIGHT_MENU                   // Add Case Light options to the LCD menu
    ...
    #define CASE_LIGHT_DEFAULT_COLOR { 0, 0, 0, 255 } // { Red, Green, Blue, White }
  #endif
#endif
...
#define DUAL_X_CARRIAGE
  ...
  #define X2_MAX_POS   379        // The max position of the X2 carriage, typically also the home position
...
#define Z_STEPPER_ALIGN_XY { {  10, 100 }, { 290,  100 } }
  //SP
  /**
...
#define CUSTOM_MENU_MAIN
  ...
  #define CUSTOM_MENU_MAIN_TITLE "Roscoe Commands"
  #define CUSTOM_MENU_MAIN_SCRIPT_DONE "M117 Roscoe IDEX Ready"
